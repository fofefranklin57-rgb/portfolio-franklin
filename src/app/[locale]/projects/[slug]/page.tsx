...
const caseStudies: Record<string, CaseStudy> = {
  ...
  kalamundi: {
    ...
    ctas: [
      { icon: '🌐', label: { fr: 'Visiter le site', en: 'Visit Website' }, href: 'https://kalamundi.pages.dev/', primary: true },
    ],
    screenshots: [
    ...
    summary: {
      fr: 'Kalamundi — "La Plume du Monde" — est une plateforme de publication numérique pensée pour les auteurs africains et mondiaux. Elle propose un flux de publication complet, une bibliothèque de 288 œuvres (domaine public et auteurs indépendants) en 50+ langues, et une interface auteur avec tableau de bord de suivi.',
      en: 'Kalamundi — "La Plume du Monde" — is a digital publishing platform designed for African and global authors. It offers an end-to-end publishing workflow, a library of 288 works (public domain and independent authors) in 50+ languages, and an author interface with a reading analytics dashboard.',
    },
    metrics: [
      { value: '288', label: { fr: 'Œuvres au catalogue', en: 'Works in catalogue' } },
      ...
      { value: '©', label: { fr: 'Protection des droits', en: 'Rights Protection' } },
    ],
    sections: [
      {
        heading: { fr: 'Contexte', en: 'Context' },
        body: {
          fr: 'Les auteurs africains manquent d\'outils de publication numérique adaptés à leurs besoins. Amazon KDP et les plateformes occidentales présentent des barrières linguistiques, des frictions de paiement et des contraintes culturelles qui pénalisent les créateurs francophones.\n\nKalamundi part d\'un constat simple : il existe une demande de contenu africain numérique — romans, poésie, contes, littérature jeunesse — mais peu de ponts entre les auteurs locaux et leurs lecteurs potentiels.',
          en: 'African authors lack digital publishing tools adapted to their needs. Amazon KDP and western platforms present language barriers, payment friction and cultural constraints that penalize francophone creators.\n\nKalamundi starts from a simple observation: there is demand for African digital content — novels, poetry, tales, children\'s literature — but few bridges between local authors and their potential readers.',
        },
      },
      {
        heading: { fr: 'Ce qui a été construit', en: 'What was built' },
        body: {
          fr: '**Flux de publication complet.** De la création du compte à la publication, en passant par l\'éditeur de texte, la gestion des chapitres, les métadonnées et les couvertures — tout le processus se fait sur la plateforme sans outil tiers.\n\n**Bibliothèque lecteur.** Catalogue de 288 œuvres — domaine public et auteurs indépendants — organisé par genre (Fiction, Non-fiction, Poésie & Oralité, Jeunesse, Littératures africaines), avec recherche par titre, auteur, pays ou mot-clé.\n\n**Protection des droits.** Un horodatage blockchain est disponible pour chaque œuvre publiée, permettant aux auteurs d\'établir une preuve d\'antériorité sans démarche juridique complexe.\n\n**Application mobile compagnon.** Une application mobile accompagne l\'expérience web pour la lecture et la publication en mobilité.',
          en: '**End-to-end publishing workflow.** From account creation to publication — text editor, chapter management, metadata and covers — the entire process happens on the platform without third-party tools.\n\n**Reader library.** Catalogue of 288 works — public domain and independent authors — organized by genre (Fiction, Non-fiction, Poetry & Oral, Youth, African Literature), with search by title, author, country or keyword.\n\n**Rights protection.** Blockchain timestamping is available for each published work, allowing authors to establish proof of authorship without complex legal procedures.\n\n**Companion mobile application.** A mobile app accompanies the web experience for reading and publishing on the go.',
        },
      },
      {
        heading: { fr: 'Difficultés rencontrées', en: 'Challenges' },
        body: {
          fr: '**Construire un catalogue multilingue.** Organiser des œuvres en 50+ langues tout en gardant la découvrabilité cohérente pour le lecteur a nécessité une architecture de métadonnées flexible dès le départ.\n\n**Concevoir pour deux publics différents.** Les auteurs veulent de la visibilité, les lecteurs veulent de la curation. Ces besoins sont parfois contradictoires — chaque décision d\'interface doit servir les deux sans en sacrifier un.\n\n**Équilibrer découverte et curation.** Un catalogue qui grandit vite devient difficile à naviguer. Trouver le bon équilibre entre algorithme et sélection éditoriale reste un chantier permanent.\n\n**Préparer un flux de publication scalable.** Anticiper l\'augmentation du volume d\'œuvres sans dégrader l\'expérience auteur ni la qualité du catalogue lecteur.',
          en: '**Building a multilingual catalogue.** Organizing works in 50+ languages while keeping discoverability coherent for readers required a flexible metadata architecture from the start.\n\n**Designing for two different user groups.** Authors want visibility, readers want curation. These needs are sometimes contradictory — every interface decision must serve both without sacrificing either.\n\n**Balancing discoverability and curation.** A fast-growing catalogue becomes difficult to navigate. Finding the right balance between algorithm and editorial selection remains an ongoing challenge.\n\n**Preparing a scalable publishing workflow.** Anticipating volume growth without degrading the author experience or the reader catalogue quality.',
        },
      },
      {
        heading: { fr: 'Pourquoi "La Plume du Monde" ?', en: 'Why "La Plume du Monde"?' },
        body: {
          fr: 'Le nom original du projet était centré sur la littérature africaine. Au fil du développement, il est devenu évident qu\'un positionnement trop étroit limiterait l\'impact dès le départ — et marginaliserait les auteurs africains dans leur propre plateforme. "La Plume du Monde" place tous les auteurs sur le même plan, tout en gardant les littératures africaines au cœur de l\'identité éditoriale.',
          en: 'The project\'s original name was centered on African literature. During development, it became clear that too narrow a positioning would limit impact from the start — and would marginalize African authors on their own platform. "La Plume du Monde" places all authors on equal footing, while keeping African literature at the heart of the editorial identity.',
        },
      },
      {
        heading: { fr: 'Ce que j\'ai appris', en: 'What I learned' },
        body: {
          fr: 'Kalamundi m\'a confronté à la complexité d\'un produit à double face (auteurs + lecteurs). Les besoins des deux publics sont parfois contradictoires : les auteurs veulent de la visibilité, les lecteurs veulent de la curation. Équilibrer les deux sans sacrifier l\'un pour l\'autre est un exercice permanent.\n\nUne fonctionnalité technique — ici la protection des droits — peut devenir un argument de confiance majeur si elle répond à une vraie anxiété des utilisateurs. Les auteurs africains ont un besoin réel de protection, mais les solutions existantes sont inaccessibles. Rendre cette protection simple et automatique a changé la conversation.\n\nEnfin, la décision de s\'ouvrir à la littérature mondiale n\'était pas un compromis — c\'était une décision produit. Atteindre une masse critique de contenu dès le lancement était la condition pour que la plateforme soit utile dès le premier jour.',
          en: 'Kalamundi confronted me with the complexity of a two-sided product (authors + readers). The needs of both audiences are sometimes contradictory: authors want visibility, readers want curation. Balancing both without sacrificing one for the other is an ongoing exercise.\n\nA technical feature — here, rights protection — can become a major trust argument when it addresses a real user anxiety. African authors have a genuine need to protect their work, but existing solutions are inaccessible. Making that protection simple and automatic changed the conversation entirely.\n\nFinally, opening to world literature was not a compromise — it was a product decision. Reaching a critical mass of content from day one was the condition for the platform to be useful from the start.',
        },
      },
    ],
  },
